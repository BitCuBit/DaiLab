...
@implementation DAILabSceneBathRoom
...
- (void) loadTextures {
    UIImage *image = [UIImage imageNamed:@"FRONT_BathRoom.png"];
    NSError *error;
    ...
    image = [UIImage imageNamed:@"LEFT_BathRoom.png"];
    ...
    if (error)
        NSLog(@"Error loading texture from image: %@", error);
    image = [UIImage imageNamed:@"BACK_BathRoom.png"];
    ...
    if (error)
        NSLog(@"Error loading texture from image: %@", error);
    image = [UIImage imageNamed:@"RIGHT_BathRoom.png"];
    ...
    if (error)
        NSLog(@"Error loading texture from image: %@", error);
    image = [UIImage imageNamed:@"BOTTOM_BathRoom.png"];
    ...
    if (error)
        NSLog(@"Error loading texture from image: %@", error);
    image = [UIImage imageNamed:@"TOP_BathRoom.png"];
